...
\usepackage{amsmath,graphicx,booktabs,longtable,caption}
\begin{document}
% Paste-ready fragment converted from ``Jimmy Final Draft.docx``.
% Preamble additions required by this fragment: \usepackage{booktabs,longtable,graphicx}.
...
\midrule
I don't recall having taped the paper onto the surface of the clipboard for maximum flatness of the surface. The paper is clipped on the right side but not the left & This means when we do the perspective shifts it might have slight distortions \newline \includegraphics[width=\linewidth]{Images/JimmyDraft/image1.jpeg} \\
Some are really slanted for some reason. I ended up correcting it by drawing lines with respect to the direction of the slant and then measuring with that angle & \includegraphics[width=\linewidth]{Images/JimmyDraft/image2.jpeg} \newline \includegraphics[width=\linewidth]{Images/JimmyDraft/image3.png} \\
Some of the fringes are too unclear to be seen I have noted them in my data when there were issues measuring & \includegraphics[width=\linewidth]{Images/JimmyDraft/image4.png} \\
There are shadows sometimes in the data. This is also noted & \includegraphics[width=\linewidth]{Images/JimmyDraft/image5.png} \\
\bottomrule
\end{longtable}
...
\caption{Linear-regression output: y=0.0000119974x-0.00000429071, R\\textasciicircum{}2=0.9982, r=0.9991.}\label{fig:regression-output}
\end{figure}
...
\includegraphics[width=\linewidth]{Images/JimmyDraft/image3.png} \newline \includegraphics[width=\linewidth]{Images/JimmyDraft/image2.jpeg} & Some ofthe interference pattern isn't perfectly horizontal and are slanted & I had to draw lines that are parallelto the angle, and use that as a reference to accurately measure the distance in the software with greater validity \\
